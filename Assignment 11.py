...
while choice != 6:
    ...
    if choice == 1:
        ...
        print("\nAfter sorting the list with Bubble Sort, your list now looks like:")
        print(my_list)
        ...
        print("\nAfter sorting the list with Selection Sort, your list now looks like:")
        print(my_list)
        ...
        print("\nAfter sorting the list with Insertion Sort, your list now looks like:")
        print(my_list)
        ...
        print("\nAfter sorting the list with Merge Sort, your list now looks like:")
        print(my_list)
        ...
        print("\nAfter sorting the list with Quick Sort, your list now looks like:")
        print(my_list)
